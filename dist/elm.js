...
var $author$project$Main$navbar = A2(
	...
	_List_fromArray(
		[
			...
			{
				label: $mdgriffith$elm_ui$Element$text('Paragraph 1'),
				url: '#paragraph5'
			})
		]));
	...
	_List_fromArray(
		[
			...
			A2(
				...
				{description: 'Github', src: 'images/github.svg'}))
		]));
		...
		[
			...
			_List_fromArray(
				[
					...
					$author$project$Main$para('paragraph2'),
					$author$project$Main$para('paragraph2'),
					$author$project$Main$para('paragraph2'),
					$author$project$Main$para('paragraph2'),
					$author$project$Main$para('paragraph2'),
					$author$project$Main$para('paragraph2'),
					$author$project$Main$para('paragraph2'),
					$author$project$Main$para('paragraph5')
				]))
		]));
